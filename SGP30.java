...
/**
 * Java driver for Adafruit SGP30
...
public class SGP30 {
    ...
    /**
     * @param address I2C address to use for communication with SGP30
     * @param wordLen Word length of SGP30 communication (usually 2)
     * @param busNo   Bus no. used by the SGP30, by default the Raspberry Pi will only have I2C bus 1 enabled
     ...
     * SGP30 sensor will almost always have 0x58 as address and a wordLength of 2
     ...
     * @throws InterruptedException interrupted during delay
     */
    public int[] iaqMeasure() throws IOException, InterruptedException {
     ...
     *
     * @throws IOException                              could not get SGP30 instance on I2C bus
     * @throws I2CFactory.UnsupportedBusNumberException wrong bus no
     */
